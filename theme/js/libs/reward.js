...
(function($){
	...
	function write(){
		...
		+ "       <img  class=\"qrcode-img qrCode_0\" id=\"qrCode_0\" src=\"/images/weixin.png\" />"
		+ "      </div>"
		...
		+ "       <img  class=\"qrcode-img qrCode_1\" id=\"qrCode_1\" src=\"/images/alipay.png\" />"
		+ "      </div>"
		+ "      <p class=\"qrcode-tip\">打赏</p>"
		+ "     </div>"
		+ "    </div>"
